...
(function() {
	...
	bt1.transform = bt2.transform = bt3.transform = Ti.UI.create2DMatrix().rotate(30).translate(0, 30).scale(5.0);
	...
	function _hide() {
		[bt3, bt2, bt1].forEach(function(bt, i) {
			bt.animate({
				...
				delay : 100 * i,
				transform : Ti.UI.create2DMatrix().rotate(30).translate(0, 30).scale(5.0),
				opaque : true,
				opacity : 0.0,
			});
		});
